...
(function (window, undefined) {
    ...
    var init = function (us) {
        ...
        settings = {
            ...
            roundedBorder: user_settings.roundedBorder
        };
    ...
    var styleWhiteKey = function (key) {
        ...
        var borderRadius = settings.roundedBorder ? "5px" : "0";

        var styleString = '0 0 ' + borderRadius + ' ' + borderRadius;
        key.el.style.borderRadius = styleString;
    ...
    var styleBlackKey = function (key) {
        ...
        var borderRadius = settings.roundedBorder ? "3px" : "0";
    ...
    */
    var mouseDown = function (element, callback) {
        if (element.tagName.toLowerCase() == 'li') {
            ...
            console.log("element.index: ", element.getAttribute("data-note-index"));
        }
    };
    ...
    */
    var createKey = function (key) {
        ...
        key.el.setAttribute('data-note-index', key.index);
